...
public class ShooterConfig {
  ...
  public static double[] interpolate(ShooterConfig obj1, ShooterConfig obj2, double distance) {
    double[] returnArray = new double[2];
    returnArray[0] =
        ((obj1.getVelocity() - obj2.getVelocity()) / (obj1.getDistance() - obj2.getDistance()))
                * (distance - obj2.getDistance())
            + obj2.getVelocity();
    returnArray[1] =
        ((obj1.getAngleDegrees() - obj2.getAngleDegrees())
                    / (obj1.getDistance() - obj2.getDistance()))
                * (distance - obj2.getDistance())
            + obj2.getAngleDegrees();
    return returnArray;
  }
}
