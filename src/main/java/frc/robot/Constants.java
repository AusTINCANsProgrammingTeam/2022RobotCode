...
public final class Constants {
  ...
  public enum Auton {
    ...
    TWOBALL("TwoBall", "paths/TwoBall1.wpilib.json", 
                       "paths/TwoBall2.wpilib.json"),
    TWOBALLSTEAL1("TwoBallSteal1"),
    TWOBALLSTEAL2("TwoBallSteal2"),
    THREEBALL("ThreeBall", "paths/Three1.wpilib.json", 
                           "paths/Three2.wpilib.json", 
                           "paths/Three3.wpilib.json", 
                           "paths/Three4.wpilib.json"),
    FOURBALL("FourBall", "paths/Four1.wpilib.json", 
                         "paths/Four2.wpilib.json", 
                         "paths/Four3.wpilib.json", 
                         "paths/Four4.wpilib.json"),
    FIVEBALL("FiveBall", "paths/Five1.wpilib.json", 
